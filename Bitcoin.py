...
app = Flask(__name__)
d=pd.read_csv(r'C:\Users\RETECH-01\Downloads\BitcoinPricePrediction-main\BitcoinPricePrediction-main\dataset\bitstampUSD_1-min_data_2012-01-01_to_2021-03-31.csv')
model = pickle.load(open(r"C:\Users\RETECH-01\Downloads\BitcoinPricePrediction-main\BitcoinPricePrediction-main\Bitcoin.pkl", "rb"))
